  ...
  return (
    <div className="bg-dblack">
      <div className="flex flex-col-reverse md:flex-row items-center max-w-7xl mx-auto justify-between px-6 py-10 md:px-16 md:py-20">
        ...
        {/* Right Side Content */}
        <div className="md:w-1/2 text-center justify-start md:text-left">
          <h1 className="font-semibold text-2xl text-white text-center relative bottom-1 lg:mt-0 mt-10 lg:text-3xl mb-8">
            ABOUT US
          </h1>
          <p className="mt-4 max-w-3xl relative left-0 lg:left-10 bottom-1 text-white text-lg">
          ...
          <p className="mt-4 max-w-3xl relative left-0 lg:left-10 lg:mb-0 mb-10 text-white text-lg">
